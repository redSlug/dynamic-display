# Deploy
Changes are automatically deployed when each commit is push to `main` as per [github actions](.github/workflows/deploy.yml)

[View last deployment time](https://dynamicdisplay.xyz/static/version.txt)

## Setup server with automatic deploys
